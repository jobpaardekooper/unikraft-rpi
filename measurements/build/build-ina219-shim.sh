#!/bin/bash
# build-ina219-shim.sh — build Unikraft image with GPIO + I2C + HD44780 LCD + INA219
#
# Layers enabled:
#   LIBBCM2835_GPIO   — FreeBSD GPIO shim (KOBJ dispatch)
#   LIBBCM2835_I2C    — FreeBSD BSC1 shim (KOBJ dispatch, polled MMIO)
#   LIBBCM2835_LCD    — native HD44780 driver on top of uk_i2c_write()
#   LIBBCM2835_INA219 — native INA219 current/power monitor driver
#
...
cp ${SCRIPT_DIR}/ina219-shim-config .config
cp ${REPO}/measurements/ina219-shim/main.c ./main.c
