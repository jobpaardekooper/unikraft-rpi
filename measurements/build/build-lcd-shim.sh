#!/bin/bash
# build-lcd-shim.sh — build Unikraft image with GPIO + I2C + HD44780 LCD driver
#
# Layers enabled:
...
cp ${SCRIPT_DIR}/lcd-shim-config .config
cp ${REPO}/measurements/lcd-shim/main.c ./main.c
