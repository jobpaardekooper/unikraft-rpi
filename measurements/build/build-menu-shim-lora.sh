#!/bin/bash
# build-menu-shim-lora.sh — Unikraft image: menu + INA219 + LCD + LoRa (E220)
#
# Layers:
...
#   LIBBCM2835_UART    — native PL011 UART0 driver (serial console disabled)
...
cp ${SCRIPT_DIR}/menu-shim-lora-config .config
cp ${REPO}/measurements/menu-shim-lora/main.c ./main.c
